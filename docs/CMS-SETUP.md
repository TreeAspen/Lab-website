...
3. 填写：
   ...
   - **Authorization callback URL**: `https://YOUR-WORKER.workers.dev/callback`
     （这个 URL 暂时填占位，等下一步部署完 Worker 拿到真实地址再回来改）
4. 创建完成后，记下两个值：
   - **Client ID**：公开值
