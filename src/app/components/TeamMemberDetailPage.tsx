      ...
      >
        <div className="relative border-2 border-white/30 rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row bg-[#0a0a0a]">
            ...
            {/* 🌟 核心修改：使用 aspect-[4/3] 锁定左侧头像区比例，并去除了所有灰度/透明滤镜 */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {linkedProjects.map((proj) => (
                <Link
                  ...
                  className="group bg-[#0a0a0a] border border-white/15 rounded-xl overflow-hidden hover:border-[#FF7A00]/60 transition-all"
                >
                  <div className="p-4 flex items-center justify-between border-b border-white/10">
                    <h4 className="font-['VT323'] text-xl uppercase group-hover:text-[#E2F16B] transition-colors truncate">
                      {proj.title}
                    </h4>
                    <ExternalLink className="w-4 h-4 text-white/30 group-hover:text-[#FF7A00] transition-colors" />
                  </div>
                  <div className="p-4">
