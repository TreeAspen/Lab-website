...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: "highlights/:id", Component: HighlightDetailPage },
      { path: "*", Component: () => <div className="flex flex-col items-center justify-center py-32 px-4 text-center">
        <h1 className="font-['VT323'] text-[12rem] leading-none text-[#FF7A00] mb-4">
          404
        </h1>
        <div className="font-['VT323'] text-3xl mb-12 uppercase tracking-widest bg-black text-[#E2F16B] px-6 py-2">
